...
export const projectsData = [
  { id: "emity", src: emity, alt: "screenshot from emity work", className: "emity", title: "Emity",
  ...
  { id: "la-seconde-vie-de-suzie", src: suzie, alt: "screenshot from La seconde vie de Suzie website", className: "suzie", title: "La seconde vie de Suzie",
  ...
  { id: "dixcit", src: dixcit, alt: "screenshot from Dixcit website", className: "dixcit", title: "Dixcit",
    description: "Concept and development of the showcase website for the Dixcit tech company",
    keywords: ["Figma", "Wordpress"], category: "design"},
  { id: "color-picker", src: colorPicker, alt: "placeholder image", className: "color-picker", title: "color picker feature",
  ...
  { id: "ai-duel", src: aiDuel, alt: "Screenshot from the AI-Duel app", className: "ai-duel", title: "AI-Duel",
